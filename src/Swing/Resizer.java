...
/**
 * The Resizer class is used to make a component (like a JFrame or JPanel) resizable by the user.
 * It detects mouse movements along the edges of the component and allows resizing in all four directions (NORTH, SOUTH, EAST, WEST).
 * The class also ensures that resizing is constrained within minimum and maximum size limits.
 */
...
public class Resizer extends MouseAdapter {
    ...
    public Resizer(Component... components) {
        this(new Insets(5, 5, 5, 5), new Dimension(1, 1), components);
    }

    public Resizer(Insets dragInsets, Component... components) {
        this(dragInsets, new Dimension(1, 1), components);
    }

    public Resizer(Insets dragInsets, Dimension snapSize, Component... components) {
